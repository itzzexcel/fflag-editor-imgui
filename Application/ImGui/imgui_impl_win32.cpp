...
static void ImGui_ImplWin32_CreateWindow(ImGuiViewport* viewport)
{
    ...
    vd->Hwnd = ::CreateWindowEx(
        vd->DwExStyle, _T("Application"), _T("Untitled"), vd->DwStyle,       // Style, class name, window name
...
static void ImGui_ImplWin32_InitPlatformInterface(bool platform_has_own_dc)
{
    ...
    wcex.lpszClassName = _T("Application");
...
static void ImGui_ImplWin32_ShutdownPlatformInterface()
{
    ::UnregisterClass(_T("Application"), ::GetModuleHandle(nullptr));
